												...
												<tr>
													...
													%>
															<td width="33%">
																<div align="left">
																	|&nbsp;&nbsp;欢迎,<%=p.getUsername()%>&nbsp;&nbsp;|&nbsp;&nbsp;
																	<a href="<%=path%>/login.action?a=out" class="table_t">注销</a>&nbsp;&nbsp;|<a href="javascript:history.back()">&lt;&lt;&lt;返回</a>
																</div>
															</td>
															<td width="19%">
																<div align="center">
																	<a href="<%=path%>/product.action?a=all">
															...
															<td width="16%">
																<div align="center">
																	<a href="<%=path%>/order.action?a=all">订单管理</a>
																</div>
															</td>
															<td width="16%">
																<div align="center">
													...
													%>
															<td width="33%">
																<div align="left">
																	|&nbsp;&nbsp;欢迎,<%=p.getUsername()%>&nbsp;&nbsp;|&nbsp;&nbsp;
																	<a href="<%=path%>/login.action?a=out" class="table_t">注销</a>&nbsp;&nbsp;|
																</div>
															</td>
															<td width="19%">
																<div align="center">
															...
															<td width="16%">
																<div align="center">
																	<a href="<%=path%>/product.action?a=all">继续购物</a>
																</div>
															</td>
															<td width="16%" height="50">
																<div align="center">
													...
													<tbody>
														...
														%>
																<tr bgcolor="#f3f3f3">
																	...
																	<td>
																		<div align="center">
																			<a href="<%=path%>/order.action?a=lookuse&uid=<%=od.getProductuser().getUid()%>"><%=od.getProductuser().getUid()%></a>
																		</div>
																	</td>
																	<td>
																		<div align="center">
																			<a href="<%=path%>/order.action?a=finditem&oid=<%=orderid %>" >查看</a>
																		</div>
																	</td>
																	<td>
																		<div align="center">
																			<a href="<%=path%>/order.action?a=delorder&oid=<%=orderid%>" >删除</a>
																		</div>
																	</td>
																</tr>
														<%
